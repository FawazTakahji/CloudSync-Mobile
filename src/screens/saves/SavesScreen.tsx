...
export function SavesScreen() {
    ...
    const compareToLocal = React.useCallback((info: SaveInfo): CompareResult => compare(info, localSaves), [localSaves]);
    const compareToCloud = React.useCallback((info: SaveInfo): CompareResult => compare(info, cloudSaves), [cloudSaves]);
